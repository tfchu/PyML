...
def train_model(bs = 100):
    ...
    model.fit(x_train, y_train, batch_size=bs, epochs=20)
    ...
    # ma: 'mse' + 'adam'
    model.save('models/model_ca_bs_{}.h5'.format(bs))
...
def load_trained_model(bs=100):
    # load training data and testing data
    (x_train, y_train), (x_test, y_test) = load_data()

    # load trained model
    model = load_model('models/model_ca_bs_{}.h5'.format(bs))
...
if __name__ == '__main__':
    batch_sizes = [1000, 2000, 3000, 4000, 5000]
