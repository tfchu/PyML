...
# features: n x i
# lables: 1 x n
def update_weights_bias(weights, bias, lr):
    # 1 x n
...
def train(weights, bias, lr, iters):
    cost_history = []

    for i in range(iters):
        weights, bias = update_weights_bias(weights, bias, lr)
        #print(weights)
        #print(weights, bias)
...
def main():
    ...
    lr = 1.
    iteration = 100000
    weights, bias = train(w0, b0, lr, iteration)
    print(weights, bias)
